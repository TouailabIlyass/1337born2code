...
/*   Updated: 2018/08/01 15:15:04 by itouaila         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdio.h>
#include <stdlib.h>
...
int	is_in_square(int **t, int row, int col, int value)
{
	int i;
	int j;
...
int	is_in_row(int **t, int row, int col, int value)
{
	int i;
...
int	is_in_col(int **t, int row, int col, int value)
{
	int i;
...
int check_possibilite(int **t,int i, int j, sudoku **debut)
{
    int k;
    int cp;
...
arbre	*remplir(int **t, int si, int sj, int *cp, sudoku **debut)
{
	arbre	*a;
	int		i;
	int		j;
...
void    is_unique(int **t, int cp,sudoku *debut,arbre *root)
{
    sudoku tmp;
...
void solve_square(int **t, int cp, sudoku *debut, arbre *root)
{
    int ligne;
    int column;
    int si;
